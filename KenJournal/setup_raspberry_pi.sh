...
sudo apt-get install -y arc-theme papirus-icon-theme breeze-cursor-theme syncthing ghostwriter flatpak firefox-esr
...
sudo apt-get remove -y vlc chromium-browser chromium-browser-l10n chromium-codecs-ffmpeg
