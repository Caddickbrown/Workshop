...
'Archiving
    ...
    Sheets(DestinationTab).Range("H" & LastUsedRow + 1).Value = Sheets(SourceTab).Range("AN1").Value 'Blocked Components
    Sheets(DestinationTab).Range("I" & LastUsedRow + 1).Value = Sheets(SourceTab).Range("AP1").Value 'Total Components
    Sheets(DestinationTab).Range("J" & LastUsedRow + 1).Value = Sheets(SourceTab).Range("AR1").Value '% Material Available
