        ...
        if not no_export_var.get():
            ...
            summary_data = pd.DataFrame({
                'Metric': [
                    ...
                    'Packaging Hours',
                    'Packaging Quantity',
                    'Malosa Instruments (3805)',
                    'Malosa Instrument Hours',
                    'Malosa Instrument Quantity',
                    'Virtuoso (3806)',
                    'Virtuoso Hours',
                    'Virtuoso Quantity',
                    '---4',  # Separator
                ...
                'Value': [
                    ...
                    f"{metrics['releasable_bvi_kits_count']:,}",
                    f"{metrics['releasable_bvi_kits_hours']:,.1f}",
                    f"{metrics['releasable_bvi_kits_qty']:,}",
                    f"{metrics['releasable_malosa_kits_count']:,}",
                    f"{metrics['releasable_malosa_kits_hours']:,.1f}",
                    f"{metrics['releasable_malosa_kits_qty']:,}",
                    '---',  # Separator
                    f"{metrics['releasable_instruments_count']:,}",
                    f"{metrics['releasable_instruments_hours']:,.1f}",
                    f"{metrics['releasable_instruments_qty']:,}",
                    f"{metrics['releasable_manufacturing_count']:,}",
                    f"{metrics['releasable_manufacturing_hours']:,.1f}",
                    f"{metrics['releasable_manufacturing_qty']:,}",
                    f"{metrics['releasable_assembly_count']:,}",
                    f"{metrics['releasable_assembly_hours']:,.1f}",
                    f"{metrics['releasable_assembly_qty']:,}",
                    f"{metrics['releasable_packaging_count']:,}",
                    f"{metrics['releasable_packaging_hours']:,.1f}",
                    f"{metrics['releasable_packaging_qty']:,}",
                    f"{metrics['releasable_malosa_instruments_count']:,}",
                    f"{metrics['releasable_malosa_instruments_hours']:,.1f}",
                    f"{metrics['releasable_malosa_instruments_qty']:,}",
                    f"{metrics['releasable_virtuoso_count']:,}",
                    f"{metrics['releasable_virtuoso_hours']:,.1f}",
                    f"{metrics['releasable_virtuoso_qty']:,}",
                    '---',  # Separator
